...
export default function NavBar() {
  ...
  useEffect(()=>{
	...
	return (
		<Disclosure as="nav" style={{backgroundColor: "rgb(17, 29, 74)"}} class="bg-blue-900 sticky top-0 z-10">
		{({open}) => (
			<>
						...
						<div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
							...
							<div className="hidden sm:block sm:ml-6">
								<div className="flex space-x-4">
									...
									<Link key="Quizzes" to="/quizzes" className={`text-gray-300 hover:bg-gray-700 ${loggedIn? 'block':'hidden'} hover:text-white px-3 py-2 rounded-md text-sm font-medium`}>
										TSA
									</Link>
									...
									<Link key="" to="" className={`text-gray-300 hover:bg-gray-700 ${loggedIn? 'block':'hidden'} hover:text-white px-3 py-2 rounded-md text-sm font-medium`}>
										Networking
									</Link>
				...
				<Disclosure.Panel className="sm:hidden">
					<div className="px-2 pt-2 pb-3 space-y-1">
						...
						<Disclosure.Button key="" to="" className={`text-gray-300 hover:bg-gray-700 ${loggedIn? 'block':'hidden'} hover:text-white px-3 py-2 rounded-md text-sm font-medium`}>
							Networking
						</Disclosure.Button>

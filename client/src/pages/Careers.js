    ...
    return (
        <div className="max-w-4xl mx-auto py-3">
            ...
            <div id="clusts">
                ...
                <br/>
				{/*<SitePal embed='8617581,480,256,"",1,1,2754295,0,1,1,"XSzky8FmxavpedLzx1XxxKzk2Y1Bcoiu",0,0,"256|480|15|15|L|B|false|0|0|0|0|https://vhss.oddcast.com/admin/img//no_image.jpg|Double%20click%20to%20play%20me|0|C|0|0|0|0"'/>*/}
				...
				<ul>
					...
					<div style={{display: 'flex',  justifyContent:'center', alignItems:'center'}}>
						...
						<ThemeProvider theme={theme}>
							<Button onClick={() => displayImage(child, 'sample-careers')} variant="contained">
								View Sample Careers
							</Button>
						</ThemeProvider>

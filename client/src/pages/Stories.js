...
export default function Stories(){
    ...
    const [stories, setStories] = useState([
        ...
        {   id:5,
            ...
            playedFor: [
                ...
                'Seattle Seahawks ( 2011, 2014-2015)​',
        ...
        {   id:7,
            ...
            position:"Safety​",
            playedFor: [
                'Tennessee Titans (2010-2011)', 'Pittsburg Steelers (2012)'
        ...
        {   id:9,
            ...
            playedFor: [
                ...
                'Carolina Panthers (2000-2003, 2006)​',
        ...
        {   id:13,
            ...
            playedFor: [
                'Australia in London 2012 Olympic Games',
                'Australia in Tokyo 2020 Olympic Games'
            ]
    ...
    const addTeam =()=>{
        setPlayed([...played, team])
        setTeam("")

    }
    const addStory=()=>{
        setStories([...stories, {name: name, title: title, job:job, school: school, position: position, playedFor: played, photo1: photo1, photo2: photo2 }])
    }
  ...
  const handleClose = () => {
			...
			>
                ...
                <Stack spacing={1}>
                    ...
                    {played.map((ans)=>(
						...
						<p className="font-semibold text-base">{ans}</p>
										
					))}
                    <Grid item xs={3}>
                        <TextField onChange={ e => setTeam(e.target.value)} value={team} id="outlined-basic" label="Add a team" variant="outlined"></TextField>

						<Button color="success" onClick= {addTeam} className="p-3" variant="outlined"><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
							<path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
							</svg>
                        </Button>

					</Grid>
                    <Button color="success" onClick= {addStory} className="p-3" variant="contained">Add this story
                        </Button>
                </Stack>
    ...
    if (query === '') {
      return post;
    } else if (post.name.toLowerCase().includes(query.toLowerCase()) || post.title.toLowerCase().includes(query.toLowerCase())) {
      return post;
    }
  }).map((story, idx) => (
    <ReactCardFlip className="mb-5" isFlipped={story.flipped? true: false} flipDirection="vertical">
            <div className="mb-5">
                <Card sx={{ maxWidth: 400, minHeight: 500, maxHeight: 500   }} key="front">
                    <CardActionArea onClick={() => handleToggleComplete(idx)}>
                        <CardMedia 
                        component="img"
                        height="200"
                        image={story.photo1}
                    ...
                    <CardActionArea onClick={() =>handleToggleComplete(idx)}>
                        ...
                        <CardContent>
                            ...
                            <p class="text-lg pt-3 font-semibold">Played for:</p>
                                ...
                                {story.playedFor.map(played => 
                                    <><p class="text-base">{played}​​</p></>
                                )}
